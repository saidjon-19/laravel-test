            ...
            <ul class="sidebar-nav">
                ...
                <li class="sidebar-item">
                    <a class="sidebar-link" href="{{route('questions.index')}}">
                        <i class="align-middle" data-feather="grid"></i> <span class="align-middle">Questions</span>
                    </a>
                </li>
                <li class="sidebar-item">
                    <a class="sidebar-link" href="{{route('variants.index')}}">
                        <i class="align-middle" data-feather="grid"></i> <span class="align-middle">Variants</span>
                    </a>
                </li>
                <li class="sidebar-item">
                    <a class="sidebar-link" href="{{route('test_types.index')}}">
                        <i class="align-middle" data-feather="grid"></i> <span class="align-middle">Test_types</span>
                    </a>
                </li>
                <li class="sidebar-item">
                    <a class="sidebar-link" href="{{route('true_false_questions.index')}}">
                        <i class="align-middle" data-feather="grid"></i> <span class="align-middle">True_False_Questions</span>
                    </a>
                </li>
                <li class="sidebar-item">
                    <a class="sidebar-link" href="{{route('short_answer_questions.index')}}">
                        <i class="align-middle" data-feather="grid"></i> <span class="align-middle">Short_Answer_Question</span>
                    </a>
                </li>
    ...
    <div class="main">
        ...
        <main class="content">
            <div class="container-fluid p-0">
                ...
                <h1 class="h3 mb-3">@yield('header')</h1>
            @yield('content')
        </main>
